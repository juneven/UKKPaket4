...
$getDataKeranjang = getData("SELECT * FROM keranjang WHERE idKeranjang = $idKeranjang")[0];
$getDataProducts = getData("SELECT * FROM produk WHERE ProdukID = '$produkID'")[0];

if( isset( $_POST["buy"] ) ) {
    if( buyItemWithCheckout($_POST) > 0 ) {
        echo "<script>
    ...
    <div class="row">
        <div class="col-lg-5 mx-auto">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="penjualan_id" class="form-control" id="floatingInput" placeholder="Your Penjualan ID" value="<?= $getDataKeranjang["PenjualanID"]; ?>" readonly>
                ...
                <div class="form-floating mb-3">
                <input type="number" name="total_products" class="form-control" id="floatingInput" placeholder="Insert Your Total Purchase Items" value="<?= $getDataKeranjang["JumlahProduk"]; ?>" readonly>
                <label for="floatingInput">Purchase Items</label>
                </div>
                <div class="form-floating mb-3">
                <input type="number" name="subtotal" class="form-control subtotal" id="floatingInput" placeholder="Your Subtotal" value="<?= $getDataKeranjang["subtotal"]; ?>" readonly>
