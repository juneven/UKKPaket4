...
$getDataProducts = getData("SELECT * FROM produk WHERE idProduk = $produkID")[0];

if( isset( $_POST["checkoutProduct"] ) ) {
    if( addCheckout($_POST) > 0 ) {
        echo "<script>
             alert('Produk Ini Berhasil Ditambahkan Keranjang!');
             document.location.href = 'index.php?file=products';
        </script>";
    } else {
        echo "<script>
             alert('Produk Ini Gagal Ditambahkan Keranjang!');
        </script>";
    }
}
        ...
        <div class="col-lg-5 mx-auto">
            ...
            <form action="" method="post">
                ...
                <div class="d-grid gap-2">
                    <button name="checkoutProduct" class="btn btn-primary" type="submit">Checkout</button>
